...
There is an FAQ post on Piazza. **Due date: Thursday, May 14 @ 11:59 PM PST**
...
|    +-- submission.txt          **Submit this file for Task 2**
```
...
## Task 1: Testing and Implementation of Deque, Stack, and Queue [95 points]
...
There are a couple questions comparing implementing Stacks and Queues with a Deque compared to an ArrayList.

Your task: Submit **submission.txt** on Gradescope to PA6-Task2. This will NOT be eligible for resubmission.
